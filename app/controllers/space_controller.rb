...
class SpaceController < ApplicationController
  ...
  def works
    works_name = ["boyakerukyoukai", "kehai", "audioracing", "Graviter", "Inside-Out_Outside-In_Or", "A_flog_in_his_house", "Projections_of_impressions", "emotional_distance", "NUM", "with_rain"]
